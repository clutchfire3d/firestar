...
* [2. Legal Disclaimer](#2-legal-disclaimer--liability)
...
**If you find this project valuable, please consider supporting our work.**
...
### **Trigger**
Install the trigger blade. Note the specific slot to prevent the selector from over-rotating. Secure with an M3 screw.
![Trigger Install](Pages/Images/img1.jpg)

### **Grip Inserts**
Using a soldering iron, install the M3 brass inserts into the Pistol Grip mounting holes.
...
### **Inserts**
Install M3 inserts into both sides of the Upper Receiver and the Outer Barrel.
![Upper Inserts](Pages/Images/img6.jpg)

### **Muzzle**
Screw the 14mm CCW adapter onto the Outer Barrel tip.
...
### **Nut Setup**
Place the M5 nut inside the specific slot within the Lower Receiver.
![M5 Nut](Pages/Images/img19.jpg)

### **Fixation**
Install the Stock Adapter before the HPA system and secure it with the M5 screw.
...
### **Wiring**
Route the FCU wires through the Stock Adapter and the air line through the Pistol Grip hole.
![Wiring Route](Pages/Images/img21.jpg)

### **Trigger Box**
Slide the Trigger Housing into the Lower and lock it with the **Lower Pin**.
...
### **Lock**
Install the **F2 Lock** to prevent the engine from moving during shots.
![Engine Lock](Pages/Images/img24.jpg)

### **Closing**
Join the Upper and Lower receivers and lock with the front pin.
![Body Pins](Pages/Images/img25.jpg)

### **Mag Release**
Install the printed (or aftermarket M4) Mag Release with the spring. Ensure smooth movement.
...
### **Carbon Tube**
Cut the carbon fiber tube to length and drill the mounting holes.

### **Stock**
Install M3 inserts into the printed Stock part and bolt it to the tube.
